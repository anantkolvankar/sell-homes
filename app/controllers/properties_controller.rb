class PropertiesController < ApplicationController
  ...
  private
    ...
    def property_params
      params.require(:property).permit(:title, :description, :price, :pincode, :region, :area, :address, :user_id, :property_type_id,amenity_ids: [], property_images_attributes: [:id , :photo, :title])
    end
end
